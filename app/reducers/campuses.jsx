...
export const fetchCampuses = () =>
  dispatch => {
    axios.get('/api/campuses').then(res => dispatch(init(res.data)));
  };
...
export const addCampus = campus =>
  dispatch => {
    axios
      ...
      .catch(err =>
        console.error(`Creating campus: ${campus} unsuccesful`, err));
  };
...
export const updateCampus = (id, campus) =>
  dispatch => {
    axios
      ...
      .catch(err =>
        console.error(`Updating campus: ${campus} unsuccesful`, err));
  };
