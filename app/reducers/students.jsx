...
// these are ASYNC action-creators that accept SYNCHRONOUS action-creators
// as a paramater for their dispatch function
export const fetchStudents = () =>
  dispatch => {
    axios.get('/api/students').then(res => dispatch(init(res.data)));
  };
...
export const addStudent = student =>
  dispatch => {
    axios
      ...
      .catch(err =>
        console.error(`Creating student: ${student} unsuccesful`, err));
  };
...
export const updateStudent = (id, student) =>
  dispatch => {
    axios
      ...
      .catch(err =>
        console.error(`Updating student: ${student} unsuccesful`, err));
  };
